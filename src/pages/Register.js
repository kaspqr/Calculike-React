...
const Register = () => {
  ...
  const [unTakenErrVisible, setUnTakenErrVisible] = useState(false)
  const [matchErrVisible, setMatchErrVisible] = useState(false)
  const [unErrVisible, setUnErrVisible] = useState(false)
      ...
      <div id='login-page'>
        <div id='login-box'>
          <form id='register-form' onSubmit={handleRegister}>
            ...
            >
              Username must be 4-12 characters long and may only contain numbers and
            ...
            >
              ...
              letters of the English alphabet and the following symbols:<br />
              {regex}
            </div>
          </form>
        </div>
